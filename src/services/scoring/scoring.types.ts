...
/* ----------------------------------------------------------------- */
/* Field types — mirrors the dynamic-form `lead_fields.type` column   */
/* ----------------------------------------------------------------- */
...
/* ----------------------------------------------------------------- */
/* Predicate (pure RQB shape, no scoring fields)                       */
/* ----------------------------------------------------------------- */
...
/* ----------------------------------------------------------------- */
/* Scoring branch — predicate with attached score/label                */
/* (lives at the top level of a dimension's `rules` array)            */
/* ----------------------------------------------------------------- */
