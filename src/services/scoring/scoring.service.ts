...
export class ScoringService {
  ...
  async getConfig(): Promise<ScoringConfigRow> {
   ...
   */
  async upsertConfig(config: ScoringConfig): Promise<ScoringConfigRow> {
   ...
   * touch any lead.
   */
  async preview(request: PreviewScoringRequest): Promise<LeadScoringResult> {
