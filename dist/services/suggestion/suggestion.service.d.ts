...
import { CreateSuggestionsRequest, CreateSuggestionsResult, DecideAllResult, DecideSuggestionRequest, PendingSuggestionSummary, Suggestion } from "./suggestion.types";
export declare class SuggestionService {
    ...
    getPendingSummary(): Promise<PendingSuggestionSummary[]>;
